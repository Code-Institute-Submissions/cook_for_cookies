# MILESTONE PROJECT NAME:  DATA CENTRIC DEVELOPMENT - FLAME & SIZZLE.COM
## NAME:  GIANCARLO FIORLETTA


## INTRODUCTION:

In this project I have created a recipes website to demonstrate my understanding of 
the flask microframework and mongodb databases.  From a user perspective the website 
should allow them to view, add and edit recipes and ingredients and also to review 
other peoples recipes and potentially appear on the sites leaderboard if they receive 
the best reviews.
